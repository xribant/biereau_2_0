 ...
 */
final class Version20210511214330 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adept_cycle ADD CONSTRAINT FK_B2E61F13492C8BE FOREIGN KEY (nearest_location_id) REFERENCES adept_place_location (id)');
